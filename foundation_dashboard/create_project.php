...
<div class="main">
  ...
  <h2>Hello,  <span style="color: blue"> <?php echo $membername ;?></span> Manage Project Here. </h2> <br />
  ...
  <table class="table table-bordered" id="project">
    ...
    <tbody>
      <?php
      $project= $connection->query("SELECT * FROM project where project_owner ='".$membername."'");
      $temp = '';
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form enctype="multipart/form-data" action="../manage_project/edit_project.php?project_id=<?php echo $row['project_id'];?>" method="post" >
		 ...
		 <div class="form-group">
           <input type="text" name="target_amount" id="target_amount" class="form-control"  value="<?php echo $row['target_amount']?>" ></input>
         </div>
         <div class="form-group">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="../manage_project/add_project.php" method="post" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
           <input type="text" name="target_amount" id="target_amount" class="form-control"  placeholder="Enter target amount" ></input>
         </div>
           <div class="form-group">
            <input type="text" class="form-control" name="project_owner" id="project_owner" placeholder="Enter project_owner" value="<?php echo $membername ?>"></input>
          </div>
