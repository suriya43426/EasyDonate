...
<div class="main">
  ...
  <h2>Hello,  <span style="color: blue"> <?php echo $_SESSION['membername']?></span> Manage Members Here. </h2> <br />
  ...
  <table class="table table-bordered" id="members">
    ...
    <tbody>
      <?php
      $members= $connection->query("SELECT * FROM member WHERE usertype like 'foundation'");
