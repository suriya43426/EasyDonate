    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
         ...
         <a href="../manage_member/delete_member.php?filepath=admin_dashboard&&member_id=<?php echo $row['member_id'];?>"> <button type="button" class="btn btn-danger">Delete</button></a>
  ...
  <div class="modal fade" id="editmember<?php echo $row['member_id'];?>" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        <form enctype="multipart/form-data" action="../manage_member/edit_member.php?filepath=admin_dashboard&&member_id=<?php echo $row['member_id'];?>" method="post" >
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="../manage_member/add_member.php" method="post" enctype="multipart/form-data">
                 <input type="hidden" name="filepath" value="admin_dashboard"></input>
