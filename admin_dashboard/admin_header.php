			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="members.php" class=""><i class="lnr lnr-cog"></i> <span>Manage Foundation</span></a></li>
						<li><a href="activate_project.php" class=""><i class="lnr lnr-alarm"></i> <span>Manage Project</span></a></li>
